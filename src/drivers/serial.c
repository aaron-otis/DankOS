...
/** @brief Circular queue for serial device. */
static struct UART uart;

/** @brief Initialized the serial bounded buffer.
 * @param *uart the structure containing the bounded buffer.
 */
 ...
 * @post The serial driver is initialized.
 */
...
/** @brief Write byte to hardware.
 *
 * Writes a byte to the serial controller transmit buffer.
 * @param byte the byte to write to hardware.
 * @pre A byte has been prepared to be written to hardware.
 * @post The byte has been written to hardware.
 */
...
/** @brief Queues a string to be written to the serial device.
 * @param *buff a character array of bytes to be written.
 * @param len the length of the character array.
 * @pre A string has been generated to be written to the serial device.
 * @post The string has been queued for writing to the serial device.
 */
...
/** @brief Queues a byte to be written to the serial device.
 * @param c a byte to be written.
 * @pre A generated byte is ready to be written to the serial device.
 * @post The byte has been queued to be written to the serial device.
 */
...
/** @brief Interrupt handler for serial device.
 *
 * @param irq the IRQ raised by hardware.
 * @param error is not used in this function.
 * @param *arg additional data used to preform functions.
 */
